...
class PlayState extends MusicBeatState
{
	...
	var santa:FlxSprite;
	var stagecurtainsDark:FlxSprite;
	var stageCurtains:FlxSprite;
	var spotLight:FlxSprite;
	var spotlightSwitch:FlxSprite;
	var stageShader:FlxSprite;
	var stageGlow:FlxSprite;
	var stageCircles:FlxSprite;
	var glowSwitch:FlxSprite;
				...
				case 'darkstage':
					{
						...
						spotLight = new FlxSprite(-600, -200);
						...
						spotlightSwitch = new FlxSprite(-600, -200);
						spotlightSwitch.frames = Paths.getSparrowAtlas('spotlightswitch');
						spotlightSwitch.animation.addByPrefix('loop', 'spotlightswitch', 24, true);
						spotlightSwitch.animation.play('loop', false);

						spotlightSwitch.updateHitbox();
						spotlightSwitch.antialiasing = true;
						spotlightSwitch.scrollFactor.set(1, 1);
						spotlightSwitch.visible = false;
						spotlightSwitch.active = false;

						stagecurtainsDark = new FlxSprite(-500, -300);
						stagecurtainsDark.loadGraphic(Paths.image('stagecurtainsdark'));
						stagecurtainsDark.setGraphicSize(Std.int(stagecurtainsDark.width * 0.9));
						stagecurtainsDark.updateHitbox();
						if(FlxG.save.data.antialiasing)
							{
								stagecurtainsDark.antialiasing = true;
							}
						stagecurtainsDark.scrollFactor.set(1.3, 1.3);
						stagecurtainsDark.active = false;
						

						stageShader = new FlxSprite(-600, -200);
						stageShader.loadGraphic(Paths.image('stageshader'));

						stageGlow = new FlxSprite(-521, 468);
						stageGlow.loadGraphic(Paths.image('stageglow'));
						stageGlow.setGraphicSize(Std.int(stageGlow.width * 1.1));
							if(FlxG.save.data.antialiasing)
							{
								stageGlow.antialiasing = true;
							}
						stageGlow.scrollFactor.set(0.9, 0.9);
						

						glowSwitch = new FlxSprite(-650, 423);
						glowSwitch.frames = Paths.getSparrowAtlas('glowswitch');
						glowSwitch.animation.addByPrefix('loop', 'glowswitch', 24, true);
						if(FlxG.save.data.distractions)
						{
							glowSwitch.animation.play('loop');
						}
						glowSwitch.setGraphicSize(Std.int(glowSwitch.width * 1.1));
						glowSwitch.updateHitbox();
						glowSwitch.antialiasing = true;
						glowSwitch.scrollFactor.set(0.9, 0.9);
						glowSwitch.visible = false;
						glowSwitch.active = false;

						stageCircles = new FlxSprite(-523, 630);
						stageCircles.loadGraphic(Paths.image('stagecircles'));
						stageCircles.setGraphicSize(Std.int(stageCircles.width * 1.1));
							if(FlxG.save.data.antialiasing)
							{
								stageCircles.antialiasing = true;
							}
						stageCircles.scrollFactor.set(0.9, 0.9);
						
						darkScreen = new FlxSprite(-650, 0);
						darkScreen.makeGraphic(FlxG.width * 4, FlxG.height * 4, FlxColor.BLACK);
	...
	override public function update(elapsed:Float)
	{
		...
		if (curSong == 'Plastic-funk')
		{
			switch (curBeat)
			{
				case 8:
					spotlightSwitch.animation.play('loop', true);
					spotlightSwitch.active = true;

					glowSwitch.animation.play('loop', true);
					glowSwitch.active = true;
			}
		}
		...
		if (curSong == 'Plastic-funk')
		{
			switch (curStep)
			{
				...
				case 643:
					FlxTween.tween(FlxG.camera, {zoom: 0.87}, 0.08);

				case 705:
					FlxTween.tween(FlxG.camera, {zoom: 0.97}, 0.25);

				case 737:
					FlxTween.tween(FlxG.camera, {zoom: 0.97}, 0.3);

				case 745:
					FlxTween.tween(FlxG.camera, {zoom: 0.97}, 0.2,
						{ease: FlxEase.expoOut});

				case 756:
					FlxTween.tween(FlxG.camera, {zoom: 0.92}, 0.1);

				case 764:
					FlxTween.tween(FlxG.camera, {zoom: 0.94}, 0.13);

				case 884:
					FlxTween.tween(FlxG.camera, {zoom: 0.85}, 0.8, 
						{ease: FlxEase.expoOut});
				...
				case 1009:
					FlxTween.tween(FlxG.camera, {zoom: 0.85}, 1.2, 
						{ease: FlxEase.expoOut});

				case 1025:
					FlxTween.tween(FlxG.camera, {zoom: 1.0}, 0.4);

				case 1029:
					FlxTween.tween(FlxG.camera, {zoom: 1.1}, 0.4);

				case 1033:
					FlxTween.tween(FlxG.camera, {zoom: 1.15}, 0.4);

				case 1037:
					FlxTween.tween(FlxG.camera, {zoom: 1.25}, 0.3, 
						{ease: FlxEase.expoOut});
				...
				case 1075:
					FlxTween.tween(FlxG.camera, {zoom: 0.89}, 0.2);

				case 1072:
					FlxTween.tween(FlxG.camera, {zoom: 0.95}, 0.2);
				...
				case 1121:
					FlxTween.tween(FlxG.camera, {zoom: 0.87}, 0.06);

				case 1123:
					FlxTween.tween(FlxG.camera, {zoom: 0.87}, 0.15);

				case 1132:
					FlxTween.tween(FlxG.camera, {zoom: 0.95}, 0.25);

				case 1137:
					FlxTween.tween(FlxG.camera, {zoom: 0.85}, 1, 
						{ease: FlxEase.expoOut});
				...
				case 1299:
					FlxTween.tween(FlxG.camera, {zoom: 0.87}, 0.05);

				case 1317:
					FlxTween.tween(FlxG.camera, {zoom: 0.87}, 0.08);

				case 1321:
					FlxTween.tween(FlxG.camera, {zoom: 0.95}, 14,
						{ease: FlxEase.expoOut});
				...
				case 1489:
					FlxTween.tween(FlxG.camera, {zoom: 0.97}, 0.35, 
						{ease: FlxEase.expoOut});

				case 1495:
					FlxTween.tween(FlxG.camera, {zoom: 0.97}, 0.5, 
						{ease: FlxEase.expoOut});
				...
				case 1521:
					FlxTween.tween(FlxG.camera, {zoom: 0.95}, 1.05, 
						{ease: FlxEase.expoOut});

				case 1519:
					FlxTween.tween(FlxG.camera, {zoom: 0.98}, 0.15);

				case 1533:
					FlxTween.tween(FlxG.camera, {zoom: 0.87}, 0.06);

				case 1537:
					FlxTween.tween(FlxG.camera, {zoom: 0.85}, 0.06);

				case 1545:
					FlxTween.tween(FlxG.camera, {zoom: 0.86}, 0.04);

				case 1547:
					FlxTween.tween(FlxG.camera, {zoom: 0.86}, 0.04);

				case 1549:
					FlxTween.tween(FlxG.camera, {zoom: 0.94}, 0.04);

				case 1551:
					FlxTween.tween(FlxG.camera, {zoom: 0.94}, 0.04);

				case 1569:
					FlxTween.tween(FlxG.camera, {zoom: 0.95}, 0.45);

				case 1581:
					FlxTween.tween(FlxG.camera, {zoom: 1.0}, 0.2,
						{ease: FlxEase.expoOut});										
				...
				case 1696:
					FlxTween.tween(FlxG.camera, {zoom: 1.0}, 6.8, 
						{ease: FlxEase.expoOut});

				case 1781:
					FlxTween.tween(FlxG.camera, {zoom: 0.87}, 0.3, 
						{ease: FlxEase.expoOut});

				case 1785:
					FlxTween.tween(FlxG.camera, {zoom: 1.0}, 0.9, 
						{ease: FlxEase.expoOut});

				case 1791:
					FlxTween.tween(FlxG.camera, {zoom: 1.1}, 1.4, 
						{ease: FlxEase.expoOut});
				...
				case 1824:
					FlxTween.tween(FlxG.camera, {zoom: 1.05}, 6.8, 
						{ease: FlxEase.expoOut});
				...
				case 1953: 
					FlxTween.tween(FlxG.camera, {zoom: 1.05}, 1.65,
						{ease: FlxEase.expoOut});
				...
				case 1969:
					...
					stageGlow.visible = true;
					spotLight.visible = true;
					FlxTween.tween(FlxG.camera, {zoom: 0.84}, 1.7);
	...
	override function stepHit()
	{
		...
		if (curStep == 273 && curSong =='Plastic-funk')
		{
		...
		if (curStep == 529 && curSong =='Plastic-funk')
		{
		...
		if (curStep == 897 && curSong =='Plastic-funk')
		{
		...
		if (curStep == 1185 && curSong =='Plastic-funk')
		{
		...
		if (curStep == 1681 && curSong =='Plastic-funk')
		{
		...
		if (curStep == 1969 && curSong =='Plastic-funk')
		{
